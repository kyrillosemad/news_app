...
class SPORTS_NEWS extends StatefulWidget {
  const SPORTS_NEWS({super.key});

  @override
  State<SPORTS_NEWS> createState() => _SPORTS_NEWSState();
}

class _SPORTS_NEWSState extends State<SPORTS_NEWS> {
  @override
