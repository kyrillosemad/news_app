...
import 'package:news_app/data/health_data.dart';
...
class HEALTH_NEWS extends StatefulWidget {
  const HEALTH_NEWS({super.key});

  @override
  State<HEALTH_NEWS> createState() => _HEALTH_NEWSState();
}

class _HEALTH_NEWSState extends State<HEALTH_NEWS> {
  @override
