...
class GENERAL_NEWS extends StatefulWidget {
  const GENERAL_NEWS({super.key});

  @override
  State<GENERAL_NEWS> createState() => _GENERAL_NEWSState();
}

class _GENERAL_NEWSState extends State<GENERAL_NEWS> {
  @override
