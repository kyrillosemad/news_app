...
import 'package:news_app/data/tech_data.dart';
...
class TECH_NEWS extends StatefulWidget {
  const TECH_NEWS({super.key});

  @override
  State<TECH_NEWS> createState() => _TECH_NEWSState();
}

class _TECH_NEWSState extends State<TECH_NEWS> {
  @override
